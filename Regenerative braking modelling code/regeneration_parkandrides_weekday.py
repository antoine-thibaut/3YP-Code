...
# Route parameters:
bus_500_total_distance_weekday = 187     # Weekday
bus_500_trips_weekday = 22               # Number of trips in a day, weekday
bus_500_stops = 7                
bus_500_gallons_weekday = bus_500_total_distance_weekday/bus_mpg # Gallons consumed by bus 500
bus_500_litres_weekday = bus_500_gallons_weekday*4.546
bus_500_total_energy_weekday = bus_500_litres_weekday*diesel_energy_density # Energy equivalent
bus_500_trip_energy_weekday = bus_500_total_energy_weekday/bus_500_trips_weekday # Energy for 1 trip
...
bus_400_total_distance_weekday = 365.8       # Weekday
bus_400_trips_weekday = 59                   # Number of trips in a day
bus_400_stops = 5                    
bus_400_gallons_weekday = bus_400_total_distance_weekday/bus_mpg # Gallons consumed by bus 400
bus_400_litres_weekday = bus_400_gallons_weekday*4.546
bus_400_total_energy_weekday = bus_400_litres_weekday*diesel_energy_density # Energy equivalent
bus_400_trip_energy_weekday = bus_400_total_energy_weekday/bus_400_trips_weekday    # Energy for 1 trip
...
bus_300_total_distance_weekday = 511.2        # Weekday
bus_300_trips_weekday = 72                    # Number of trips in a day
bus_300_stops = 26                    
bus_300_gallons_weekday = bus_300_total_distance_weekday/bus_mpg # Gallons consumed by bus 300
bus_300_litres_weekday = bus_300_gallons_weekday*4.546
bus_300_total_energy_weekday = bus_300_litres_weekday*diesel_energy_density # Energy equivalent
bus_300_trip_energy_weekday = bus_300_total_energy_weekday/bus_300_trips_weekday # Energy for 1 trip:
...
bus_S5_total_distance_weekday = 742          # Weekday
bus_S5_trips_weekday = 53                    # Number of trips in a day
bus_S5_stops = 7                     
bus_S5_gallons_weekday = bus_S5_total_distance_weekday/bus_mpg # Gallons consumed by bus S5
bus_S5_litres_weekday = bus_S5_gallons_weekday*4.546
bus_S5_total_energy_weekday = bus_S5_litres_weekday*diesel_energy_density # Energy equivalent
bus_S5_trip_energy_weekday = bus_S5_total_energy_weekday/bus_S5_trips_weekday # Energy for 1 trip
...
bus_500_outbound_regenerative_trip_energy = bus_500_trip_energy_weekday - bus_500_outbound_total_braking_energy
...
# Energy with regenerative system:
bus_500_inbound_regenerative_trip_energy = bus_500_trip_energy_weekday - bus_500_inbound_total_braking_energy
...
# Energy with regenerative system:
bus_400_outbound_regenerative_trip_energy = bus_400_trip_energy_weekday - bus_400_outbound_total_braking_energy
...
# Energy with regenerative system:
bus_400_inbound_regenerative_trip_energy = bus_400_trip_energy_weekday - bus_400_inbound_total_braking_energy
...
# Energy with regenerative system:
bus_300_outbound_regenerative_trip_energy = bus_300_trip_energy_weekday - bus_300_outbound_total_braking_energy
...
# Energy with regenerative system:
bus_300_inbound_regenerative_trip_energy = bus_300_trip_energy_weekday - bus_300_inbound_total_braking_energy
...
# Energy with regenerative system:
bus_S5_outbound_regenerative_trip_energy = bus_S5_trip_energy_weekday - bus_S5_outbound_total_braking_energy
...
# Energy with regenerative system:
bus_S5_inbound_regenerative_trip_energy = bus_S5_trip_energy_weekday - bus_S5_inbound_total_braking_energy
...
data_energies = {'Type':  ['A', 'B','C'],
                 'Trip energies': [bus_500_trip_energy_weekday/(10**6), bus_500_outbound_regenerative_trip_energy/(10**6), (bus_500_outbound_regenerative_trip_energy-bus_500_total_stop_energy)/(10**6)]}
...
data_saved_energies = {'Route':  ['500 (outbound)','500 (inbound)','400 (outbound)','400 (inbound)',
                       ...
                       'Energy saved trough RBS one year [MJ]': [bus_500_outbound_RBS_energy_saved*bus_500_trips_weekday*365*(5/7),bus_500_inbound_RBS_energy_saved*bus_500_trips_weekday*365*(5/7),
                                                                 bus_400_outbound_RBS_energy_saved*bus_400_trips_weekday*365*(5/7),bus_400_inbound_RBS_energy_saved*bus_400_trips_weekday*365*(5/7),
                                                                 bus_300_outbound_RBS_energy_saved*bus_300_trips_weekday*365*(5/7),bus_300_inbound_RBS_energy_saved*bus_300_trips_weekday*365*(5/7),
                                                                 bus_S5_outbound_RBS_energy_saved*bus_S5_trips_weekday*365*(5/7),bus_S5_inbound_RBS_energy_saved*bus_S5_trips_weekday*365*(5/7)]}
...
df_saved_energies = df_saved_energies.assign(kg_hydrongen_saved_year = [((bus_500_outbound_RBS_energy_saved/hydrogen_energy_density)*bus_500_trips_weekday*365*(5/7))/hydrogen_energy_efficiency,
                                                                        ((bus_500_inbound_RBS_energy_saved/hydrogen_energy_density)*bus_500_trips_weekday*365*(5/7))/hydrogen_energy_efficiency,
                                                                        ((bus_400_outbound_RBS_energy_saved/hydrogen_energy_density)*bus_400_trips_weekday*365*(5/7))/hydrogen_energy_efficiency,
                                                                        ((bus_400_inbound_RBS_energy_saved/hydrogen_energy_density)*bus_400_trips_weekday*365*(5/7))/hydrogen_energy_efficiency,
                                                                        ((bus_300_outbound_RBS_energy_saved/hydrogen_energy_density)*bus_300_trips_weekday*365*(5/7))/hydrogen_energy_efficiency,
                                                                        ((bus_300_inbound_RBS_energy_saved/hydrogen_energy_density)*bus_300_trips_weekday*365*(5/7))/hydrogen_energy_efficiency,
                                                                        ((bus_S5_outbound_RBS_energy_saved/hydrogen_energy_density)*bus_S5_trips_weekday*365*(5/7))/hydrogen_energy_efficiency,
                                                                        ((bus_S5_inbound_RBS_energy_saved/hydrogen_energy_density)*bus_S5_trips_weekday*365*(5/7))/hydrogen_energy_efficiency])

df_saved_energies = df_saved_energies.assign(kg_hydrongen_saved_weekday = [((bus_500_outbound_RBS_energy_saved/hydrogen_energy_density)*bus_500_trips_weekday)/hydrogen_energy_efficiency,
...
df_saved_energies.to_csv('saved_energies_weekdays.csv', index=False)
