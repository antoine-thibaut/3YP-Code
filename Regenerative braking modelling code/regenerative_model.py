...
df_saved_energies = df_saved_energies.assign(kg_hydrongen_saved_year = [(((bus_500_outbound_RBS_energy_saved/hydrogen_energy_density)*bus_500_trips_weekday*365*(5/7))+((bus_500_outbound_RBS_energy_saved/hydrogen_energy_density)*bus_500_trips_weekend*365*(2/7)))/hydrogen_energy_efficiency,
