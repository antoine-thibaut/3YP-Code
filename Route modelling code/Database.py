...
bus_2_gallon = (df_bus_2.iloc[0][2]/df_bus_2.iloc[0][3],df_bus_2.iloc[1][2]/df_bus_2.iloc[1][3],df_bus_2.iloc[2][2]/df_bus_2.iloc[2][3],df_bus_2.iloc[3][2]/df_bus_2.iloc[3][3],df_bus_2.iloc[4][2]/df_bus_2.iloc[4][3])
bus_2A_gallon = (df_bus_2A.iloc[0][2]/df_bus_2A.iloc[0][3],df_bus_2A.iloc[1][2]/df_bus_2A.iloc[1][3],df_bus_2A.iloc[2][2]/df_bus_2A.iloc[2][3],df_bus_2A.iloc[3][2]/df_bus_2A.iloc[3][3],df_bus_2A.iloc[4][2]/df_bus_2A.iloc[4][3])
bus_2B_gallon = (df_bus_2B.iloc[0][2]/df_bus_2B.iloc[0][3],df_bus_2B.iloc[1][2]/df_bus_2B.iloc[1][3],df_bus_2B.iloc[2][2]/df_bus_2B.iloc[2][3],df_bus_2B.iloc[3][2]/df_bus_2B.iloc[3][3],df_bus_2B.iloc[4][2]/df_bus_2B.iloc[4][3])
bus_3_gallon = (df_bus_3.iloc[0][2]/df_bus_3.iloc[0][3],df_bus_3.iloc[1][2]/df_bus_3.iloc[1][3],df_bus_3.iloc[2][2]/df_bus_3.iloc[2][3],df_bus_3.iloc[3][2]/df_bus_3.iloc[3][3],df_bus_3.iloc[4][2]/df_bus_3.iloc[4][3])
bus_3A_gallon = (df_bus_3A.iloc[0][2]/df_bus_3A.iloc[0][3],df_bus_3A.iloc[1][2]/df_bus_3A.iloc[1][3],df_bus_3A.iloc[2][2]/df_bus_3A.iloc[2][3],df_bus_3A.iloc[3][2]/df_bus_3A.iloc[3][3],df_bus_3A.iloc[4][2]/df_bus_3A.iloc[4][3])
bus_4_gallon = (df_bus_4.iloc[0][2]/df_bus_4.iloc[0][3],df_bus_4.iloc[1][2]/df_bus_4.iloc[1][3],df_bus_4.iloc[2][2]/df_bus_4.iloc[2][3],df_bus_4.iloc[3][2]/df_bus_4.iloc[3][3],df_bus_4.iloc[4][2]/df_bus_4.iloc[4][3])
bus_5_gallon = (df_bus_5.iloc[0][2]/df_bus_5.iloc[0][3],df_bus_5.iloc[1][2]/df_bus_5.iloc[1][3],df_bus_5.iloc[2][2]/df_bus_5.iloc[2][3],df_bus_5.iloc[3][2]/df_bus_5.iloc[3][3],df_bus_5.iloc[4][2]/df_bus_5.iloc[4][3])
bus_6_gallon = (df_bus_6.iloc[0][2]/df_bus_6.iloc[0][3],df_bus_6.iloc[1][2]/df_bus_6.iloc[1][3],df_bus_6.iloc[2][2]/df_bus_6.iloc[2][3],df_bus_6.iloc[3][2]/df_bus_6.iloc[3][3],df_bus_6.iloc[4][2]/df_bus_6.iloc[4][3])
bus_8_gallon = (df_bus_8.iloc[0][2]/df_bus_8.iloc[0][3],df_bus_8.iloc[1][2]/df_bus_8.iloc[1][3],df_bus_8.iloc[2][2]/df_bus_8.iloc[2][3],df_bus_8.iloc[3][2]/df_bus_8.iloc[3][3],df_bus_8.iloc[4][2]/df_bus_8.iloc[4][3])
bus_9_gallon = (df_bus_9.iloc[0][2]/df_bus_9.iloc[0][3],df_bus_9.iloc[1][2]/df_bus_9.iloc[1][3],df_bus_9.iloc[2][2]/df_bus_9.iloc[2][3],df_bus_9.iloc[3][2]/df_bus_9.iloc[3][3],df_bus_9.iloc[4][2]/df_bus_9.iloc[4][3])
bus_11X_gallon = (df_bus_11X.iloc[0][2]/df_bus_11X.iloc[0][3],df_bus_11X.iloc[1][2]/df_bus_11X.iloc[1][3],df_bus_11X.iloc[2][2]/df_bus_11X.iloc[2][3],df_bus_11X.iloc[3][2]/df_bus_11X.iloc[3][3],df_bus_11X.iloc[4][2]/df_bus_11X.iloc[4][3])
bus_13X_gallon = (df_bus_13X.iloc[0][2]/df_bus_13X.iloc[0][3],df_bus_13X.iloc[1][2]/df_bus_13X.iloc[1][3],df_bus_13X.iloc[2][2]/df_bus_13X.iloc[2][3],df_bus_13X.iloc[3][2]/df_bus_13X.iloc[3][3],df_bus_13X.iloc[4][2]/df_bus_13X.iloc[4][3])
bus_U6_gallon = (df_bus_U6.iloc[0][2]/df_bus_U6.iloc[0][3],df_bus_U6.iloc[1][2]/df_bus_U6.iloc[1][3],df_bus_U6.iloc[2][2]/df_bus_U6.iloc[2][3],df_bus_U6.iloc[3][2]/df_bus_U6.iloc[3][3],df_bus_U6.iloc[4][2]/df_bus_U6.iloc[4][3])
bus_500_gallon = (df_bus_500.iloc[0][2]/df_bus_500.iloc[0][3],df_bus_500.iloc[1][2]/df_bus_500.iloc[1][3],df_bus_500.iloc[2][2]/df_bus_500.iloc[2][3],df_bus_500.iloc[3][2]/df_bus_500.iloc[3][3],df_bus_500.iloc[4][2]/df_bus_500.iloc[4][3])
...
rects1 = plt.bar(index, bus_2_distance, bar_width,
alpha=opacity,
color='#800000',
label='Bus 2')

rects2 = plt.bar(index + bar_width, bus_2A_distance, bar_width,
alpha=opacity,
color='#9a6324',
label='Bus 2A')

rects3 = plt.bar(index + bar_width*2, bus_2B_distance, bar_width,
alpha=opacity,
color='#808000',
label='Bus 2B')

rects4 = plt.bar(index + bar_width*3, bus_3_distance, bar_width,
alpha=opacity,
color='#469990',
label='Bus 3')

rects5 = plt.bar(index + bar_width*4, bus_3A_distance, bar_width,
alpha=opacity,
color='#000075',
label='Bus 3A')

rects6 = plt.bar(index + bar_width*5, bus_4_distance, bar_width,
alpha=opacity,
color='#000000',
label='Bus 4')

rects7 = plt.bar(index + bar_width*6, bus_5_distance, bar_width,
alpha=opacity,
color='#e6194b',
label='Bus 5')

rects8 = plt.bar(index + bar_width*7, bus_6_distance, bar_width,
alpha=opacity,
color='#f58231',
label='Bus 6')

rects9 = plt.bar(index + bar_width*8, bus_8_distance, bar_width,
alpha=opacity,
color='#ffe119',
label='Bus 8')

rects10 = plt.bar(index + bar_width*9, bus_9_distance, bar_width,
alpha=opacity,
color='#bfef45',
label='Bus 9')

rects11 = plt.bar(index + bar_width*10, bus_11X_distance, bar_width,
alpha=opacity,
color='#3cb44b',
label='Bus 11X')

rects12 = plt.bar(index + bar_width*11, bus_13X_distance, bar_width,
alpha=opacity,
color='#42d4f4',
label='Bus 13X')

rects13 = plt.bar(index + bar_width*12, bus_U6_distance, bar_width,
alpha=opacity,
color='#4363d8',
label='Bus U6')

rects14 = plt.bar(index + bar_width*13, bus_500_distance, bar_width,
alpha=opacity,
color='#911eb4',
label='Bus 500')
