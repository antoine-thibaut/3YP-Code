...
plt.ylabel('Gallons')
plt.title('Gallons of diesel consumed by each bus route during a weekend')
plt.xticks(index + bar_width, ('(4am-8am)', '(8am-12am)','(12am-4pm)','(4pm-8pm)', '(8pm-12pm)'))
plt.savefig('Gallons_weekend.svg', format='svg', dpi=1200)
