...
rects7 = plt.bar(index + bar_width*6, bus_5_gallon, bar_width,
alpha=opacity,
color='#e6194b',
label='Bus 5')

rects8 = plt.bar(index + bar_width*7, bus_6_gallon, bar_width,
alpha=opacity,
color='#f58231',
label='Bus 6')

rects9 = plt.bar(index + bar_width*8, bus_8_gallon, bar_width,
alpha=opacity,
color='#ffe119',
label='Bus 8')

rects10 = plt.bar(index + bar_width*9, bus_9_gallon, bar_width,
alpha=opacity,
color='#bfef45',
label='Bus 9')

rects11 = plt.bar(index + bar_width*10, bus_11X_gallon, bar_width,
alpha=opacity,
color='#3cb44b',
label='Bus 11X')

rects12 = plt.bar(index + bar_width*11, bus_13X_gallon, bar_width,
alpha=opacity,
color='#42d4f4',
label='Bus 13X')

rects13 = plt.bar(index + bar_width*12, bus_U6_gallon, bar_width,
alpha=opacity,
color='#4363d8',
label='Bus U6')

rects14 = plt.bar(index + bar_width*13, bus_500_gallon, bar_width,
alpha=opacity,
color='#911eb4',
label='Bus 500')
